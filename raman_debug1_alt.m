 ...
 for i=1:nits
     rayBundleB1 = pushBundleAlt(rayBundleB1,rayGd,0.1);
 end
 ...
 for chosenRay = 1:rSkip:rayBundleB1.nrays   
     ...
     %
     srsBundle2 = pushBundleAlt(srsBundle,rayGd,0.3);
     
     % advance the Raman EPW
     %
     epwBundle2 = pushBundleAlt(epwBundle,rayGd,10);
     ...
     while ~all(srsBundle2.halt)
         ...
         srsBundle2 = pushBundleAlt(srsBundle2,rayGd,0.1);
     end
