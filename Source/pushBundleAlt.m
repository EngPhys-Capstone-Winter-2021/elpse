...
%
 ...
 ncRay = rayBundle.nc;
 direction = rayBundle.direction;
 parfor rayIdx = 1:nrays
     ...
     if trajIsNew    % need IC's for trajectory
         if waveType == 'EM'
             ...
             % needed
             %
             k0 = toDispSurface(x0,frequency,ncRay,direction,rayIdx,rayGd,cnst);         
...
% $$$      end
 ...
 function k0 = toDispSurface(x0,frequency,ncRay,direction,rayIdx,rayGd,cnst)
