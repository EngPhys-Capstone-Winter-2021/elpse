 ...
 rayBundleB1 = pushBundle_CustomODE(rayBundleB1,rayGd,tPush,[100 100 100 100]);
 ...
 for i=1:nits
     rayBundleB1 = pushBundle_CustomODE(rayBundleB1,rayGd,0.1);
 end
 ...
 for chosenRay = 1:rSkip:rayBundleB1.nrays   
     ...
     %
     srsBundle2 = pushBundle_CustomODE(srsBundle,rayGd,0.3);
     
     % advance the Raman EPW
     %
     epwBundle2 = pushBundle_CustomODE(epwBundle,rayGd,10);
     ...
     while ~all(srsBundle2.halt)
         ...
         srsBundle2 = pushBundle_CustomODE(srsBundle2,rayGd,0.1);
     end
