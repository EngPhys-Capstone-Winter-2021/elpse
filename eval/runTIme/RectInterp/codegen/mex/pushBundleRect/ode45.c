...
static emlrtRSInfo m_emlrtRSI = { 518, /* lineNo */
  "ode2345",                           /* fcnName */
  "/usr/local/MATLAB/R2020b/toolbox/eml/lib/matlab/funfun/private/ode2345.m"/* pathName */
};

static emlrtRSInfo n_emlrtRSI = { 382, /* lineNo */
  "ode2345",                           /* fcnName */
  "/usr/local/MATLAB/R2020b/toolbox/eml/lib/matlab/funfun/private/ode2345.m"/* pathName */
};

static emlrtRSInfo o_emlrtRSI = { 369, /* lineNo */
  "ode2345",                           /* fcnName */
  "/usr/local/MATLAB/R2020b/toolbox/eml/lib/matlab/funfun/private/ode2345.m"/* pathName */
};

static emlrtRSInfo p_emlrtRSI = { 372, /* lineNo */
  "ode2345",                           /* fcnName */
  "/usr/local/MATLAB/R2020b/toolbox/eml/lib/matlab/funfun/private/ode2345.m"/* pathName */
};

static emlrtRSInfo q_emlrtRSI = { 371, /* lineNo */
  "ode2345",                           /* fcnName */
  "/usr/local/MATLAB/R2020b/toolbox/eml/lib/matlab/funfun/private/ode2345.m"/* pathName */
};

static emlrtRSInfo r_emlrtRSI = { 341, /* lineNo */
  "ode2345",                           /* fcnName */
  "/usr/local/MATLAB/R2020b/toolbox/eml/lib/matlab/funfun/private/ode2345.m"/* pathName */
};
...
static emlrtRSInfo t_emlrtRSI = { 311, /* lineNo */
  "ode2345",                           /* fcnName */
  "/usr/local/MATLAB/R2020b/toolbox/eml/lib/matlab/funfun/private/ode2345.m"/* pathName */
};

static emlrtRSInfo u_emlrtRSI = { 276, /* lineNo */
  "ode2345",                           /* fcnName */
  "/usr/local/MATLAB/R2020b/toolbox/eml/lib/matlab/funfun/private/ode2345.m"/* pathName */
};
...
static emlrtRTEInfo h_emlrtRTEI = { 271,/* lineNo */
  15,                                  /* colNo */
  "ode2345",                           /* fName */
  "/usr/local/MATLAB/R2020b/toolbox/eml/lib/matlab/funfun/private/ode2345.m"/* pName */
};

static emlrtRTEInfo p_emlrtRTEI = { 217,/* lineNo */
  5,                                   /* colNo */
  "ode2345",                           /* fName */
  "/usr/local/MATLAB/R2020b/toolbox/eml/lib/matlab/funfun/private/ode2345.m"/* pName */
};

static emlrtRTEInfo q_emlrtRTEI = { 218,/* lineNo */
  5,                                   /* colNo */
  "ode2345",                           /* fName */
  "/usr/local/MATLAB/R2020b/toolbox/eml/lib/matlab/funfun/private/ode2345.m"/* pName */
};

static emlrtRTEInfo r_emlrtRTEI = { 542,/* lineNo */
  1,                                   /* colNo */
  "ode2345",                           /* fName */
  "/usr/local/MATLAB/R2020b/toolbox/eml/lib/matlab/funfun/private/ode2345.m"/* pName */
};

static emlrtRTEInfo s_emlrtRTEI = { 543,/* lineNo */
  1,                                   /* colNo */
  "ode2345",                           /* fName */
  "/usr/local/MATLAB/R2020b/toolbox/eml/lib/matlab/funfun/private/ode2345.m"/* pName */
};
...
void ode45(const emlrtStack *sp, real_T ode_tunableEnvironment_f1, const real_T
           ...
           ode_tunableEnvironment_f2_gridZ[54264], const real_T tspan[2], const
           real_T b_y0[4], emxArray_real_T *varargout_1, emxArray_real_T
           *varargout_2)
{
  ...
  emxInit_real_T(&st, &tout, 2, &p_emlrtRTEI, true);
  b_st.site = &v_emlrtRSI;
  c_st.site = &w_emlrtRSI;
  d_st.site = &x_emlrtRSI;
  anon(&d_st, ode_tunableEnvironment_f1, c_ode_tunableEnvironment_f2_dom,
       c_ode_tunableEnvironment_f2_uni, d_ode_tunableEnvironment_f2_uni,
       ode_tunableEnvironment_f2_grid, ode_tunableEnvironment_f2_gridR,
       ode_tunableEnvironment_f2_gridZ, b_y0, f0);
  i = tout->size[0] * tout->size[1];
  tout->size[0] = 1;
  tout->size[1] = 200;
  emxEnsureCapacity_real_T(&st, tout, i, &p_emlrtRTEI);
  for (i = 0; i < 200; i++) {
    tout->data[i] = 0.0;
  }

  emxInit_real_T(&st, &yout, 2, &q_emlrtRTEI, true);
  i = yout->size[0] * yout->size[1];
  yout->size[0] = 4;
  yout->size[1] = 200;
  emxEnsureCapacity_real_T(&st, yout, i, &q_emlrtRTEI);
  for (i = 0; i < 800; i++) {
    yout->data[i] = 0.0;
  }
  ...
  do {
    ...
    do {
      ...
      for (j = 0; j < 5; j++) {
        ...
        anon(&d_st, ode_tunableEnvironment_f1, c_ode_tunableEnvironment_f2_dom,
             c_ode_tunableEnvironment_f2_uni, d_ode_tunableEnvironment_f2_uni,
             ode_tunableEnvironment_f2_grid, ode_tunableEnvironment_f2_gridR,
             ode_tunableEnvironment_f2_gridZ, ystage, *(real_T (*)[4])&f[(j + 1)
             << 2]);
      }
      ...
      anon(&d_st, ode_tunableEnvironment_f1, c_ode_tunableEnvironment_f2_dom,
           c_ode_tunableEnvironment_f2_uni, d_ode_tunableEnvironment_f2_uni,
           ode_tunableEnvironment_f2_grid, ode_tunableEnvironment_f2_gridR,
           ode_tunableEnvironment_f2_gridZ, ynew, *(real_T (*)[4])&f[24]);
      h_tmp = tnew - t;
      y = 0.0;
      for (ix = 0; ix < 4; ix++) {
    ...
    if (MinStepExit) {
      ...
      if (nout + 1 > tout->size[1]) {
        ...
        yout->size[0] = 4;
        yout->size[1] += 200;
        emxEnsureCapacity_real_T(&st, yout, i, &t_emlrtRTEI);
        for (j = 0; j < 200; j++) {
  ...
  emxEnsureCapacity_real_T(&st, varargout_1, i, &r_emlrtRTEI);
  for (i = 0; i <= Bcolidx; i++) {
  ...
  emxEnsureCapacity_real_T(&st, varargout_2, i, &s_emlrtRTEI);
  for (i = 0; i <= Bcolidx; i++) {
